class Player {
        ...
        this.wrapper.innerHTML = `
            ...
            <div class="player-container">
                ...
                <div class="volume-slider-container">
                    ...
                    <input type="range" min="0" max="100" value="0" class="volumeSlider volumeRange">
                    <p class="volumeLimit">
                        100
                    </p>
                </div>
    ...
    updateTime(time) {
        ...
        if (time === Math.floor(parseFloat(this.audio.duration))) {
            this.pause()
        }
    }
}